...
local user_opts = {
    ...
    font = "Inter",                        -- font for the OSC (default: mpv-osd-symbols or the one set in mpv.conf)
    ...
    zones_hover_mode = "zones",           -- mode for showing OSC/WC on mouse move: "always", "zones", "independent"
    ...
    -- Colors and style
    osc_color = "#0E0A0C",                 -- accent color of the OSC and title bar
    window_title_color = "#C8A8B0",        -- color of the title in borderless/fullscreen mode
    window_controls_color = "#C8A8B0",     -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
    windowcontrols_close_hover = "#C87878", -- color of close window control on hover
    windowcontrols_max_hover = "#C8B478",  -- color of maximize window controls on hover
    windowcontrols_min_hover = "#78B890",  -- color of minimize window controls on hover
    title_color = "#b4949e",               -- color of the title (above seekbar)
    cache_info_color = "#5b3a45",          -- color of the cache information
    seekbarfg_color = "#a55f77",           -- color of the seekbar progress and handle
    seekbarbg_color = "#0f0b0d",           -- color of the remaining seekbar
    seekbar_cache_color = "#301E24",       -- color of the cache ranges on the seekbar
    volumebar_match_seek_color = false,    -- match volume bar color with seekbar color (ignores side_buttons_color)
    time_color = "#764b5a",                -- color of the timestamps (below seekbar)
    chapter_title_color = "#b4949e",       -- color of the chapter title (above seekbar)
    side_buttons_color = "#8f5f6f",        -- color of the side buttons (audio, subtitles, playlist, etc.)
    middle_buttons_color = "#a47786",      -- color of the middle buttons (skip, jump, chapter, etc.)
    playpause_color = "#b4949e",           -- color of the play/pause button
    held_element_color = "#281018",        -- color of the element when held down (pressed)
    hover_effect_color = "#c192a2",    -- color of a hovered button when hover_effect includes "color"
    thumbnail_border_color = "#070406",    -- color of the border for thumbnails (with thumbfast)
    thumbnail_border_outline = "#180E12",  -- color of the border outline for thumbnails
    ...
    hover_effect = "size,color",      -- active button hover effects: "glow", "size", "color"; can use multiple separated by commas
    ...
    nibble_color = "#bc6a85",              -- color of chapter nibbles on the seekbar
    nibble_current_color = "#c5a4af",      -- color of the current chapter nibble on the seekbar
