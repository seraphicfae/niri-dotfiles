...
local user_opts = {
    ...
    -- Colors and style
    osc_color = "#1A141A",                 -- accent color of the OSC and title bar
    window_title_color = "#FFEAF4",        -- color of the title in borderless/fullscreen mode
    window_controls_color = "#FFD6E8",     -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
    windowcontrols_close_hover = "#FF7FA8", -- color of close window control on hover
    windowcontrols_max_hover = "#F6B6D1",  -- color of maximize window controls on hover
    windowcontrols_min_hover = "#D9A6FF",  -- color of minimize window controls on hover
    title_color = "#FFEAF4",               -- color of the title
    cache_info_color = "#F8DCE8",          -- color of the cache information
    seekbar_cache_color = "#7E6877",       -- color of the cache ranges on the seekbar
    seekbarfg_color = "#FF8FC7",           -- color of the seekbar progress
    seekbarbg_color = "#4A3A46",           -- color of the remaining seekbar
    seek_handle_color = "#E06AA3",         -- color of the seekbar handle
    seek_handle_border_color = "#FFC1DD",  -- inner border color drawn inside the seekbar handle (set to "disable" to disable)
    volumebar_match_seek_color = false,    -- match volume bar color with seekbar color (ignores side_buttons_color)
    time_color = "#FFEAF4",                -- color of the timestamps (below seekbar)
    chapter_title_color = "#FFDCEB",       -- color of the chapter title
    side_buttons_color = "#FFD6E8",        -- color of the side buttons (audio, subtitles, playlist, etc.)
    middle_buttons_color = "#FFD6E8",      -- color of the middle buttons (skip, jump, chapter, etc.)
    playpause_color = "#FFF0F7",           -- color of the play/pause button
    held_element_color = "#7A5A6B",        -- color of the element when held down (pressed)
    hover_effect_color = "#FF8FC7",        -- color of a hovered button when hover_effect includes "color"
    thumbnail_box_color = "#161116",       -- color of the background for thumbnail box
    thumbnail_box_outline = "#5C4754",     -- color of the border outline for thumbnail box
    nibble_color = "#FF8FC7",              -- color of chapter nibbles on the seekbar
    nibble_current_color = "#FFF5FA",      -- color of the current chapter nibble on the seekbar
    ab_loop_color = "#C78BFF",             -- color of the A/B loop range on the seekbar
